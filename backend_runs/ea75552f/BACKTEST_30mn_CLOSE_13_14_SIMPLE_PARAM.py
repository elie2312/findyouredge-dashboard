...
# -*- coding: utf-8 -*-
"""
BACKTEST - 30mn Close - Fenetre 13:00-14:00 UTC - Max 4 trades/jour
Regles:
- A la cloture 30mn:
    * bougie verte => LONG
    * bougie rouge => SHORT
- Entrees possibles uniquement entre 13:00 et 14:00 UTC (inclus), max 4/jour
- Sizing: 1 contrat
- SL: bas (long) / haut (short) de la bougie precedente (30mn)
- TP: 1R (distance entree-SL)
- Flat force: FLAT_TIME_UTC
Compatibilite: reprend structure CSV/UTC/front-month/trades/KPI de l'env existant.
"""
...
CSV_PATH = r"C:/Users/elieb/Desktop/Dashboard/backend_runs/ea75552f/filtered_data.csv"
...
ENTRY_WINDOW_START_UTC = "13:00:00"
ENTRY_WINDOW_END_UTC   = "14:00:00"
...
OPR_START_UTC = "13:00:00"            # Debut de session (pour decouverte)
...
def main():
    ...
    stats = kpis(trades)
    print_stats("RESULTS (30mn close - 13-14 UTC - 1R)", stats)
